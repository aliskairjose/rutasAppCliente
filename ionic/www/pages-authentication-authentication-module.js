...
let AuthenticationPage = class AuthenticationPage {
    constructor(router, _auth, _storage, formBuilder, _commonService, _loadingController) {
        this.router = router;
        this._auth = _auth;
    ...
    presentLoading() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this._loading = yield this._loadingController.create({
