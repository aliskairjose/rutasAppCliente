...
let AuthInterceptorService = class AuthInterceptorService {
    constructor(router, commonService, storageService) {
        this.router = router;
    ...
    intercept(request, next) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.storageService.get('_cap_rp_token')).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(token => {
