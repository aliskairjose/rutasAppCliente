...
const startTapClick = (config) => {
    ...
    const onTouchStart = (ev) => {
        lastTouch = Object(_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev);
        pointerDown(ev);
    };
    const onTouchEnd = (ev) => {
        lastTouch = Object(_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev);
    ...
    const onMouseDown = (ev) => {
        const t = Object(_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_0__["n"])(ev) - MOUSE_WAIT;
        if (lastTouch < t) {
            pointerDown(ev);
        }
    };
    ...
    const setActivatedElement = (el, ev) => {
        ...
        clearTimeout(activeDefer);
        activeDefer = undefined;
        const { x, y } = Object(_helpers_47d562d2_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev);
        // deactivate selected
        if (activatableEle) {
...
//# sourceMappingURL=tap-click-9e4a1234-js-es2015.js.map